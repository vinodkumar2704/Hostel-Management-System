...
<!--Header-->
			...
			<ul class="cd-radial-slider" data-radius1="0" data-radius2="1364" data-centerx1="110" data-centerx2="1290">
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='900px' width="1500px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/img1.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='900px' width="1500px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/img2.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
