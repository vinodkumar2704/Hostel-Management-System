			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<a href="#" class="dropdown-toggle nav-link active" data-toggle="dropdown">Rooms
							<b class="caret"></b>
						</a>
...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM student WHERE s_id like '$search_box%' and h_id = '$hostel_id'";
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
            ...
            $student_name = $row_search['fname']." ".$row_search['lname'];
      		...
      		echo "<tr><td>{$student_name}</td><td>{$row_search['s_id']}</td><td>{$row_search['phone_no']}</td><td>{$hostel_name}</td><td>{$room_no}</td></tr>\n";
   	   }
   }
   ?>
   </tbody>
...
<?php
   $hostel_id = $_SESSION['hostel_id'];
   $query1 = "SELECT * FROM student where h_id = '$hostel_id'";
         ...
         echo '<tr><td colspan="4">No Rows Returned</td></tr>';
      	...
      	while($row1 = mysqli_fetch_assoc($result1)){
            ...
            $student_name = $row1['fname']." ".$row1['lname'];
      		...
      		echo "<tr><td>{$student_name}</td><td>{$row1['s_id']}</td><td>{$row1['phone_no']}</td><td>{$hostel_name}</td><td>{$room_no}</td></tr>\n";
      	}
      }
    ?>
    </tbody>
