		...
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<li class="nav-item">
						<a class="nav-link active" href="message_hostel_manager.php">Messages Received</a>
					</li>
...
<?php
    ...
    <div class="container">
      <div class="card">
      <div class="card-header"><b><?php echo $row['subject_h']; ?><span style="float: right"><a href="delete_msg.php?id=<?php echo $row['msg_id']; ?>" class="btn btn-primary">Delete</a></b></div>
