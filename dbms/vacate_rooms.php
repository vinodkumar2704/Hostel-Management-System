...
if(isset($_POST['submit'])){
    ...
    $query2 = "SELECT * FROM room WHERE h_id = '$hostel_id' and room_no = '$room_number'";
	...
	$query3 = "SELECT * FROM student WHERE s_id = '$roll' and h_id = '$hostel_id' and room_id = '$room_id'";
    ...
    if($result3){
    	$query4 = "UPDATE student SET h_id = NULL, room_id = NULL WHERE s_id = '$roll'";
