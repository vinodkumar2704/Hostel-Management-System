...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM room WHERE room_no like '$search_box%' and h_id = '$hostel_id' and allocated = '0'";
...
<?php
   $hostel_id = $_SESSION['hostel_id'];
   $query1 = "SELECT * FROM room where h_id = '$hostel_id' and allocated = '0'";
